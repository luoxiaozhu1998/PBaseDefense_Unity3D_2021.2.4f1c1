...
public class GamePauseUI : IUserInterface 
{
    ...
    {
        m_EnemyKilledCountText.text = string.Format("目前杀敌数总合:{0}",SaveData.EnemyKilledCount);
        m_SoldierKilledCountText.text = string.Format("目前我方单位阵亡总合:{0}",SaveData.SoldierKilledCount);
